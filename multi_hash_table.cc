...
int MultiHashTable::InitFromBuffer(void *pBuffer, ull64_t ddwBufferSize, uint8_t cMaxKeyLen, uint16_t wRowNum, uint32_t dwIndexRatio, ull64_t ddwBlockSize, CalcHashKeyFunc HashFunc, bool bUseAccessSeq)
{
...
int MultiHashTable::CreateFromShm(const MhtInitParam &user_param)
{
	...
	return InitFromBuffer(pBuffer, param.ddwBufferSize, param.cMaxKeyLen, param.wRowNum, param.dwIndexRatio, param.ddwBlockSize, param.HashFunc, param.bUseAccessSeq);
}
